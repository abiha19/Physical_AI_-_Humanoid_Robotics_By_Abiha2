      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <div className="footer-socials">
            <a href="https://www.linkedin.com/in/ume-abiha-shakeel-761ba430b" target="_blank" className="social-icon">
            ...
            <a href="https://github.com/abiha19" target="_blank" className="social-icon">
              <div className='foot-icon'>
            ...
            <a href="mailto:u.abihashakeel@gmail.com" className="social-icon">
              <div className='foot-icon'>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
